...
export function VirtualPersonClaim({ members }: VirtualPersonClaimProps) {
  ...
  return (
    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
      <h4 className="text-sm font-semibold text-yellow-900 mb-2">Virtual Members</h4>
      <p className="text-sm text-yellow-800 mb-3">
        The following members don't have accounts yet. When someone joins using the invite link,
        they will automatically claim one of these virtual member slots.
      </p>
      ...
      <p className="mt-3 text-xs text-yellow-700">
        Virtual members can still be included in expenses. They will be claimed in the order they
        were created when new users join.
      </p>
    </div>
  );
}
