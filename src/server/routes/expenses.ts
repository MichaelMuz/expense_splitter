...
/**
 * Middleware to check that the currenly authenticated user is part of the group they are accessing
 */
async function checkGroupMembership(req: Request, res: Response, next: NextFunction) {
